...
public class AccountController {
	...
	public User createSpecificUser(String login, String password, int age, int height, int weight,
			boolean lactoseTolerance, boolean glutenTolerance, String diet, String gender) throws DietException {
	...
	public User updateUser(User changedUser, String password, int age, String diet, int height, int weight,
			boolean glutenTolerance, boolean lactoseTolerance, String gender) throws DietException {
		if (!diet.equals("NORMALNA") && !diet.equals("WEGETARIAŃSKA")) {
			throw new DietException(diet);
		}
